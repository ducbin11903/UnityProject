...
{
  public:
    // Thay đổi hàm khởi tạo: Thêm tham số 'address'
    ICM42688(I2Cdev* i2c_bus, uint8_t address); // Thêm uint8_t address
    ...
    void readFIFOData(uint8_t * data, uint16_t length);
    // ===============================================

  private:
    float _aRes, _gRes;
    I2Cdev* _i2c_bus;
    uint8_t _address; // Thêm biến thành viên để lưu địa chỉ I2C của cảm biến này
};
