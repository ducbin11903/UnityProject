...
void loop() {
  ...
  // packetToSend.middle_angle = angle_index * 0.95f;
  // packetToSend.ring_angle = angle_index * 0.90f;
  // packetToSend.pinky_angle = packetToSend.ring_angle * 0.95f;
  ...
  //Serial.printf("Sent UDP Packet: Quat(w=%.2f)\n", packetToSend.w);
