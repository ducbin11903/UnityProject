...
public class HandMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        float _qx = ESP32_UDP.qx;
        float _qy = ESP32_UDP.qy;
        float _qz = ESP32_UDP.qz;
        float _qw = ESP32_UDP.qw;
        //float _qx = ESP32_Quat.qx;
        //float _qy = ESP32_Quat.qy;
        //float _qz = ESP32_Quat.qz;
        //float _qw = ESP32_Quat.qw;
        //Rotation
        torqueX = torqueX * _qx;
        torqueY = torqueY * _qy;
        torqueZ = torqueZ * _qz;

        transform.rotation = new Quaternion(_qx, -_qz, _qy, _qw);
        /*
